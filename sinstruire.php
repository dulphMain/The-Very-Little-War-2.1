...
if($_GET['cours'] == 1) {
	...
	<p>Dans l'infiniment grand on retiendra les <span class="important">étoiles</span> (dont le Soleil), le système solaire qui contient le Soleil et <span class="important">huit planètes</span> (Mercure, Vénus, Terre, Mars, Jupiter, Saturne, Uranus, Neptune)
...
elseif($_GET['cours'] == 2) {
	...
	Z : numéro atomique (nombre de protons donc nombre d'électrons)<br>
	Si N est le nombre de neutrons :<br> 
	A = Z + N<br>
	</p>
	<div class="sousPartie">B) Caractéristiques de l'atome</div><hr>
	<div class="sousSousPartie">1) Structure lacunaire de l'atome</div><hr>
	<p>La matière constituant un atome est essentiellement concentrée dans son noyau. Les distances séparant le noyau des électrons sont très grandes comparées à la taille du noyau. Ainsi, la plus grande partie de l'atome est constituée de vide.
	...
	<div class="sousPartie">C) Classification périodique des éléments</div><hr>
	<p>La classification périodique des éléments est un tableau qui regroupe tous les éléments connus, classés par numéro atomique croissant. L'agencement du tableau est lié à la répartition électronique.<br>
	</p>
...
elseif($_GET['cours'] == 3) {
	...
	<p>La plupart des atomes existent très rarement sous forme isolée. Spontanément, ils s'assemblent entre eux pour former des <span class="important">molécules</span>. Une molécule est un édifice chimique électriquement neutre formé d'un nombre limité  <span class="important">d'atomes liés les uns aux autres.</span>
	</p>
...
elseif($_GET['cours'] == 4) {
	...
	1ère colonne : <sub>3</sub>Li (K)<sup>2</sup> (L)<sup>1</sup> => perd 1 électron de la couche L pour être en duet => Li<sup>+</sup><br>
	2ème colonne : <sub>9</sub>F (K)<sup>2</sup> (L)<sup>7</sup> => gagne 1 électron de la couche L pour être en octet => F<sup>-</sup>
	</p>
	<?php
}
elseif($_GET['cours'] == 5) {
	...
	<p>La masse molaire atomique est la masse d'une mole d'atomes de l'élément considéré. Elle s'exprime en g/mol. Les valeurs en sont données dans le tableau périodique. Les proportions des isotopes utilisées dans le calcul sont celles observées dans la nature.<br>
	Ex : M(O) = 16 g/mol
	</p>
	...
	<p>La concentration molaire est donnée par C = n/V avec C la concentration molaire (mol/L), n la quantité de matière (mol) et V le volume (L).
	</p>
	<?php
}
else {
